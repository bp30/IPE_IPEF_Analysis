...
Detint1 <- lmer(Detail.response ~ Version * Condition + (1|Participant) + (1|Story_ID), data = Exp1.df)
anova(Detint1, ddf = 'Kenward-Roger')
#-----------------------------------------------------------------------------------------------------------------------
# Coherence -- Model:lmer(Coherence.response ~ Version + (1|Participant) + (1|Story_ID), data = Exp1.df)
anova(Vdiff_coh, ddf = 'Kenward-Roger')

Cohint1 <- lmer(Coherence.response ~ Version * Condition + (1|Participant) + (1|Story_ID), data = Exp1.df)
anova(Cohint1, ddf = 'Kenward-Roger')
summary(Cohint1)
#-----------------------------------------------------------------------------------------------------------------------
...
helpint1 <- lmer(help.response ~ Version * Condition + (1|Participant) + (1|Story_ID), data = Exp1.df)
anova(helpint1, ddf = 'Kenward-Roger')
summary(helpint1)
```
...
means1 <- psych::describeBy(Exp1_pmeans.df$mean, Exp1_pmeans.df$group2, mat = T)
...
```{r}
# Detail: Figure 3A
freqplot_det.df1 <- ggpredict(int_det_exp1, c("Detail_C[-4,0,4]", "Condition"))
ggplot(freqplot_det.df1, aes(x, predicted, colour = group)) +
  geom_line() +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high, fill = group, color = NULL), alpha = .4) +
  theme_classic() +
  labs(title = "", x = "Scene Detail", y = "Willingness to help", fill = "Condition") +
...
#------------------------------------------------------------------------------------------------------------------------
# Coherence: Figure 3C
freqplot_coh.df1 <- ggpredict(int_coh_exp1, c("Coherence_C[-4,0,4]", "Condition"))
ggplot(freqplot_coh.df1, aes(x, predicted, colour = group)) +
  geom_line() +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high, fill = group, color = NULL), alpha = .4) +
  theme_classic() +
  labs(title = "",x = "Scene Coherence", y = "Willingness to help", fill = "Condition") +
  scale_color_manual(values = c(palette[2], palette[3]), 
                     labels = c("Estimate Helping", "Imagine Helping")) +
  scale_fill_manual(values = c(palette[2], palette[3]), 
                    labels = c("Estimate Helping", "Imagine Helping")) +
...
# Detail -- model: 
 Vdiff_det_bayes <- brm(data = Exp1_int, family = cumulative("logit"), 
                        Detail.response ~ Version * Condition + (1|Participant) + (Version|Story_ID),
...
# BF01
(BF01_detV <- hypothesis(Vdiff_det_bayes, hypothesis = c("Version2:ConditionImagine = 0"),alpha = 0.055, seed = 67)); plot(BF01_detV)
# pd
...
# BF01
(BF01_cohV <- hypothesis(Vdiff_coh_bayes, hypothesis = c("Version2:ConditionImagine = 0"), alpha = 0.055, seed = 67)); plot(BF01_cohV)
# pd
...
# BF01
(BF01_helpV <- hypothesis(Vdiff_help_bayes, hypothesis = c("Version2 = 0"), alpha = 0.055, seed = 67))
# pd
...
violin_PSE1 <- violin_bayes(PSE_plots1, HDI_range = c(0.055, 0.945))[[1]]
violin_PSE1 +
...
plot_det1 <- det_posterior1 %>% gather("Estimate Helping", "Imagine Helping", 
...
violin_det1 +
  ...
  theme(legend.position = 'none') +
  ylim(-0.2, 1.5) +
  scale_x_discrete(limits = c("Imagine Helping", "Estimate Helping")) +
  scale_fill_manual(values = c(palette[2], palette[3])) +
  scale_color_manual(values = c(palette[2], palette[3]))
...
coh_posterior1 <- cbind.data.frame('Estimate Helping' = posterior_coh_exp1$b_Coherence_C,
                                   "Imagine Helping" = posterior_coh_exp1$b_Coherence_C + posterior_coh_exp1$`b_ConditionImagine:Coherence_C`)
plot_coh1 <- coh_posterior1 %>% gather("Estimate Helping", "Imagine Helping", 
                                       key = Condition, value = Posterior)
...
#--------------------------------------------------------------------------------------------------------------------------
# Violin plots -- Detail and Coherence interaction effects (Figure 4E)
plot_int1 <- cbind.data.frame("Detail" = posterior_det_exp1$`b_ConditionImagine:Detail_C`, 
                              "Coherence" = posterior_coh_exp1$`b_ConditionImagine:Coherence_C`)
plot_int1 <- plot_int1 %>% gather("Detail", "Coherence", 
                                 key = Condition, value = Posterior)
violin_int1 <- violin_bayes(plot_int1, HDI_range = c(0.055, 0.945))[[1]]
violin_int1 +
  labs(x="Vividness by Condition Interactions", y ="logit") +
  theme(legend.position = "none") +
  ylim(-0.5, 1.5) +  
...
means2 <- psych::describeBy(Exp2_pmeans.df$mean, Exp2_pmeans.df$group2, mat = T)
...
```{r}
# Detail (Figure 3B)
freqplot_det.df2 <- ggpredict(int_det_exp2, c("Detail_C[-4,0,4]","Condition"))
ggplot(freqplot_det.df2, aes(x, predicted, colour = group)) +
  geom_line() +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high, fill = group, color = NULL), alpha = .4) +
  theme_classic() +
...
#-------------------------------------------------------------------------------------------------------------------------
# Coherence (Figure 3D)
freqplot_coh.df2 <- ggpredict(int_coh_exp2, c("Coherence_C[-4,0,4]","Condition"))
ggplot(freqplot_coh.df2, aes(x, predicted, colour = group)) +
  geom_line() +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high, fill = group, color = NULL), alpha = .4) +
  theme_classic() +
...
violin_det2 +
  ...
  theme(legend.position = 'none') +
  ylim(-0.2, 1.5) +
  scale_x_discrete(labels = c("Imagine Helping","Estimate Helping")) +
  scale_fill_manual(values = c(palette[2], palette[3])) +
  scale_color_manual(values = c(palette[2], palette[3]))
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------
# Violin plots -- Detail and Coherence interaction effects (Figure 4F)
...
violin_int2 <- violin_bayes(plot_int2, HDI_range = c(0.055, 0.945))[[1]]
violin_int2 +
  labs(x = "Vividness by Condition Interactions", y = "logit") + 
  theme(legend.position = "none") +
  scale_x_discrete(labels = c( "Coherence", "Detail")) +
  ylim(-0.5, 1.5) + 
  scale_fill_manual(values = c(palette[6], palette[7])) +
  scale_color_manual(values = c(palette[6], palette[7]))
#-------------------------------------------------------------------------------------------------------------------------------------------------------
