...
# Exp2_pmeans.df <- psych::describeBy(Exp2.df$help.response, group =list (Exp2.df$Condition,Exp2.df$participant), mat=TRUE, na.rm= TRUE)
# colnames(Exp2_pmeans.df)[2:3] <- c('Condition', 'Participants')
