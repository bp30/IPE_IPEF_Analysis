...
# BF01
(BF01_helpV<-hypothesis(Vdiff_help_bayes, hypothesis =c("Version2=0"),alpha=0.055,colMeans(BF01_helpV$samples>0/4e4)
# % in ROPE
rope(BF01_helpV$samples,ci=1, range = c(-0.1, 0.1)) seed=67));plot(BF01_helpV)
# pd
...
violin_PSE1+
  labs(x="Simulation Condition Contrasts", y = expression(beta))+
