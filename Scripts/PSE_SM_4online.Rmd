...
Det_OR1<- as.data.frame(exp(posterior_det_exp1$`b_ConditionImagine:Detail_C`))
colnames(Det_OR1)<- "Int"
ggplot(Det_OR1, aes(x=1, y=Int))+
...
OR2.df<- OR2 
OR2<- OR2 %>% gather("Imagine-Identify", "Imagine-Estimate", key= Condition, value= Posterior)
OR2_plot<- violin_bayes(OR2)[[1]]
violin_bayes(OR2, CI_range = c(0.055, 0.945))[[2]]
