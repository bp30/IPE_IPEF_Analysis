...
readRDS('PSE_ttest_exp1_id.rds')
# Imagine helping condition vs Estimate helping condition
readRDS('PSE_ttest_exp1_est.rds')
```
...
ggplot(freq_plot_det.df1, aes(x, predicted, colour = group)) +
  geom_line() +
...
# Imagine helping condition vs Identify media source condition
readRDS('PSE_ttest_exp2_id.rds')
# Imagine helping condition vs Estimate helping condition
readRDS('PSE_ttest_exp2_est.rds')
```
