...
#                        Detail.responsee ~ Version + (1|Participant) + (Version|Story_ID),
...
#                        Coherence.response ~ Version + (1|Participant) + (Version|Story_ID),
#                           prior = c(prior(normal(0,1), class = b), 
#                                     prior(normal(0,1.2), class = Intercept),
#                                     prior(exponential(1), class = sd),
...
#                        help.response ~ Version + (1|Participant) + (Version|Story_ID),
#                           prior = c(prior(normal(0,1), class = b), 
#                                    prior(normal(0,1.2), class = Intercept),
#                                    prior(exponential(1), class = sd),
#                                    prior(lkj(1), class = cor)), 
...
violin_int2 +
  labs(x = "Scene Vividness by Condition Interactions", y = "logit") + 
  theme(legend.position = "none") +
  scale_x_discrete(labels = c( "Scene Coherence", "Scene Detail")) +
  ylim(-0.5, 1.5) + 
  scale_fill_manual(values = c(palette[6], palette[7])) +
  scale_color_manual(values = c(palette[6], palette[7]))
#-------------------------------------------------------------------------------------------------------------------------------------------------------
