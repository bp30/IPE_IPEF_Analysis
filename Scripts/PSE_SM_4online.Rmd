...
# Exp1_pmeans.df <- psych::describeBy(Exp1.df$help.response, group =list (Exp1.df$Condition,Exp1.df$Participant), mat=TRUE, na.rm= TRUE)
# colnames(Exp1_pmeans.df)[2:3] <- c('Condition', 'Participants')
...
ggplot(freqplot_coh.df1, aes(x, predicted, colour= group)) +
  ...
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high, fill = group, color = NULL), alpha = .4) +
  theme_classic() +
  labs(title="",x="Scene Coherence", y = "Willingness to help", fill="Simulation Condition") +
  scale_color_manual(values = c(palette[2], palette[3]), 
                     labels = c("Estimate Helping", "Imagine Helping")) +
  scale_fill_manual(values = c(palette[2], palette[3]), 
                    labels = c("Estimate Helping", "Imagine Helping")) 
...
violin_det1 +
  labs(x="Simulation Condition", y = "logit") +
  theme(legend.position='none') +
  ylim(-0.2, 1.5) +
  scale_fill_manual(values=c(palette[2], palette[3])) +
  scale_color_manual(values = c(palette[2], palette[3]))
...
violin_int1 +
  labs(x="Vivindess by Simulation Condition Interactions", y ="logit") +
  theme(legend.position = "none") +
  ylim(-0.5, 1.5) +  
...
ggplot(freqplot_det.df2, aes(x, predicted, colour= group)) +
  ...
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high, fill = group, color = NULL), alpha = .4) +
  theme_classic() +
  labs(title="",x="Detail", y = "Willingness to help", fill="Simulation Condition") +
  scale_color_manual(values = c(palette[2], palette[3]), 
                     labels = c("Estimate Helping", "Imagine Helping")) +
  scale_fill_manual(values = c(palette[2], palette[3]), 
                    labels = c("Estimate Helping", "Imagine Helping"))
...
ggplot(freqplot_coh.df2, aes(x, predicted, colour= group)) +
  ...
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high, fill = group, color = NULL), alpha = .4) +
  theme_classic() +
  labs(title="",x="Coherence", y = "Willingness to help", fill="Simulation Condition") +
  scale_color_manual(values = c(palette[2], palette[3]), 
                     labels = c("Estimate Helping", "Imagine Helping")) +
  scale_fill_manual(values = c(palette[2], palette[3]), 
                    labels = c("Estimate Helping", "Imagine Helping")) 
