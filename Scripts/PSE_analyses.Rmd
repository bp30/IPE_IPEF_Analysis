...
ER_help1 <- hypothesis(Bayes_Help_exp1, c('ConditionImagine > 0' , 
                                          'ConditionImagine - ConditionEstimate > 0', 
                                          'ConditionEstimate > 0'))
# pd
colMeans(ER_help1$samples > 0)
# OR
OR1 <- exp(ER_help1$samples)
colnames(OR1) <- c("Imagine - Identify", "Imagine - Estimate", "Estimate - Identify")
...
(ER_help2 <- hypothesis(Bayes_Help_exp2, hypothesis = c("ConditionImagine > 0", 
                                                        "ConditionImagine - ConditionEstimate > 0",
                                                        "ConditionEstimate > 0"), alpha = 0.055, seed = 67))
# pd
colMeans(ER_help2$samples > 0)
# OR
OR2 <- exp(ER_help2$samples)
colnames(OR2) <- c("Imagine-Identify", "Imagine-Estimate", "Estimate-Identify")
